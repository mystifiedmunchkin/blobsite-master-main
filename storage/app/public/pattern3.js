...
function generate() {
    ...
    const numPoints = random(1000, 1200, true);
    ...
    const voronoi = createVoronoiGrid({
        ...
        height,
        points,
        relaxIterations: random(4, 8, true)
    });

    const colors = ["rgba(166, 215, 187, 1)", "rgba(215, 242, 237, 1)", "rgba(137, 177, 154,1)", "rgba(158, 204, 177,1)"];

svg.rect(width, height).fill("rgba(181,201,181,0.5)");
